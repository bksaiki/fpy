...
_OPTION_LABELS: dict[OptOptions, str] = {
    ...
    OptOptions(elim_round=True, allow_exact=False): 'elim_round',
    OptOptions(elim_round=False, allow_exact=True): 'allow_exact',
    OptOptions(elim_round=True, allow_exact=True): 'elim_round + allow_exact'
}
...
def plot_times(
    ...
    ax.set_title('Normalized Execution Time with Variance (Box-and-Whisker)', fontsize=14)
