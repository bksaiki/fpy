...
float dpa_special_values__5902d066__6f1b7fc8__bd5dfaf4e(const std::array<float, 16>& A, const std::array<float, 16>& B, float c) {
...
double fused_sum__5902d066__9fe35873__v99d6777c__b2eb6fbdb(const std::array<float, 17>& xs, float n) {
    ...
    for (int8_t t6 = 0; t6 < 17; ++t6) {
        ...
        assert((std::fabs(_tmp3) <= 134217728) && "fpy: overflow occurred so rounding is undefined");
        float _t9 = _tmp3;
...
std::array<float, 17> join__5902d066__e67def4a__b6aaa46e5(const std::array<float, 16>& xs, const std::array<float, 1>& ys) {
...
float fdpa_round__5902d066__510790d1__v5af88987__b186b0299(double s) {
...
float t_fdpa__5902d066__6f1b7fc8__bb554505e(const std::array<float, 16>& A, const std::array<float, 16>& B, float c) {
    ...
    if (t24) {
        return dpa_special_values__5902d066__6f1b7fc8__bd5dfaf4e(A, B, c);
    }
    ...
    double s = fused_sum__5902d066__9fe35873__v99d6777c__b2eb6fbdb(join__5902d066__e67def4a__b6aaa46e5(prods, std::array<float, 1>{{c}}), ((e_max - static_cast<float>(25)) - static_cast<float>(1)));
    return fdpa_round__5902d066__510790d1__v5af88987__b186b0299(s);
}

float t_fdpa_chain(const std::array<float, 32>& A, const std::array<float, 32>& B, float c) {
    float d = c;
    for (int8_t i = 0; i < 32; i += 16) {
        ...
        d = t_fdpa__5902d066__6f1b7fc8__bb554505e(_tmp1, _tmp2, d);
    }
    return d;
}
}
