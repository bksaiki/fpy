...
def test_bf16_exact_is_correctly_rounded_and_a_design_is_not(
...
def test_only_the_selected_metrics_are_computed(model: torch.nn.Module, tokens: torch.Tensor) -> None:
    run = swap.patch(model)
