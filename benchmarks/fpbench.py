...
@fpy(
    ...
    description='Generated by FPTaylor',
    precision='binary64',
    pre=lambda x1, x2, x3, x4, x5, x6: 4 <= x1 <= 3969/625 and 4 <= x2 <= 3969/625 and 4 <= x3 <= 3969/625 and 4 <= x4 <= 3969/625 and 4 <= x5 <= 3969/625 and 4 <= x6 <= 3969/625,
)
...
@fpy(
    ...
    description='Generated by FPTaylor',
    precision='binary64',
    pre=lambda x, y: 1001/1000 <= x <= 2 and 1001/1000 <= y <= 2,
)
def nonlin2(x, y):
    t = (x * y)
    return ((t - 1) / ((t * t) - 1))
...
@fpy(
    ...
    description='Generated by FPTaylor',
    precision='binary32',
    pre=lambda x, y: 1/10 <= x <= 10 and -5 <= y <= 5,
)
def i4(x, y):
    return sqrt((x + (y * y)))
...
@fpy(
    ...
    pre=lambda x, y, u, v: 0 <= u <= 1 and 0 <= v <= 1 and 0 <= x <= 3/2 and 3/8 <= y <= 11/8,
)
...
@fpy(
    name='Circle',
    cite=['bibek-2020'],
    pre=lambda x, y: -1/2 <= x <= 1/2 and -1/2 <= y <= 1/2,
)
def Circle(x, y):
    d = 0
    x0 = x
