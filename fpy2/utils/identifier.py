...
class SourceId(NamedId):
    """
    Named identifier with a source location.

    A source identifier should only be generated by the parser so
    that an original variable name can be traced back to its origin.
    """
