...
int main() {
    // Configuration
    static constexpr size_t N = 10000000; // 10 million operations
    static constexpr int PRECISION = 8;
    static constexpr fpy::RM ROUNDING_MODE = fpy::RM::RTZ;
    ...
    std::cout << "Rounding mode:  RNE (Round to Nearest Even)\n";
