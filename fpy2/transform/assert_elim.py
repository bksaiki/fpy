...
class AssertElim:
    ...
    as part of any normal form.  A backend that cannot raise wants it before
    its passes, which would otherwise decline on an assertion.
    """
