...
class TestRealFloatRoundMethods(unittest.TestCase):
    ...
    def test_round_stochastic_examples(self):
        inputs = [
            ...
            # 9 * 2 ** -3 (below halfway)
            (-3, 9, -1, 2, 0), # 9 * 2 ** -3 => 1 * 2 ** -1 (0: down)
            (-3, 9, -1, 2, 1), # 9 * 2 ** -3 => 1 * 2 ** -1 (1: down)
            (-3, 9, -1, 2, 2), # 9 * 2 ** -3 => 1 * 2 ** -1 (2: down)
            (-3, 9, -1, 3, 3), # 9 * 2 ** -3 => 1 * 3 ** -1 (3: up)
            # 10 * 2 ** -3 (exactly halfway)
            (-3, 10, -1, 2, 0), # 9 * 2 ** -3 => 1 * 2 ** -1 (0: down)
            (-3, 10, -1, 2, 1), # 9 * 2 ** -3 => 1 * 2 ** -1 (1: down)
            (-3, 10, -1, 3, 2), # 9 * 2 ** -3 => 1 * 3 ** -1 (2: up)
            (-3, 10, -1, 3, 3), # 9 * 2 ** -3 => 1 * 3 ** -1 (3: up)
            # 11 * 2 ** -3 (above halfway)
            (-3, 11, -1, 2, 0), # 11 * 2 ** -3 => 1 * 2 ** -1 (0: down)
            (-3, 11, -1, 3, 1), # 11 * 2 ** -3 => 1 * 3 ** -1 (1: up)
            (-3, 11, -1, 3, 2), # 11 * 2 ** -3 => 1 * 3 ** -1 (2: up)
            (-3, 11, -1, 3, 3), # 11 * 2 ** -3 => 1 * 3 ** -1 (3: up)
            # 12 * 2 ** -3 (representable)
            (-3, 12, -1, 3, 0), # 12 * 2 ** -3 => 1 * 3 ** -1 (0: up)
            (-3, 12, -1, 3, 1), # 12 * 2 ** -3 => 1 * 3 ** -1 (1: up)
            (-3, 12, -1, 3, 2), # 12 * 2 ** -3 => 1 * 3 ** -1 (2: up)
            (-3, 12, -1, 3, 3), # 12 * 2 ** -3 => 1 * 3 ** -1 (3: up)
        ]
